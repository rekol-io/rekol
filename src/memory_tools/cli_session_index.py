...
@click.option(
    "--incremental", "mode_incremental", is_flag=True,
...
@click.option(
    "--embed/--no-embed", default=False, show_default=True,
...
@click.option(
    "--progress/--no-progress", default=True, show_default=True,
